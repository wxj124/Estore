...
public class UserServiceImpl implements UserService {
	private UserDao dao = BasicFactory.getFactory().getInstence(UserDao.class);
	@Override
	public void regist(User user) {
		...
		try {
			...
			prop.setProperty("mail.debug", "true");//�������ΪTRUE���ڷ����ʼ�ʱ���ӡ����
			//��������������������һ�λỰ
			Session session = Session.getInstance(prop);
			Message msg = new MimeMessage(session);
			msg.setFrom(new InternetAddress("aa@wxj.com"));
	...
	public User active(String activecode) {
		...
		User user = dao.find(findU).get(0);
		//1.调用dao根据激活码查找用户,如果找不到提示激活码无效
		if(user==null){
